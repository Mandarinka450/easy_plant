      ...
      <div class="container-main">
        <div class="container-login">
             ...
             <form class="form-login" action="">
                ...
                <div class="form-login__wrapper">
                   <input class="form-login__password" type="password" placeholder="Пароль" v-model="form.password" required>
                ...
                <button class="form-login__button" @click="login">Войти</button>
             </form>
