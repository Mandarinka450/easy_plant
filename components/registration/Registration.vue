      ...
      <div class="container-main">
        <div class="block-start">
             ...
             <form class="form-login" id="form-login">
                ...
                <div class="form-login__wrapper">
                   <input class="form-login__surname" 
                   type="text" 
                   placeholder="Фамилия" 
                   id="surname"
                   v-model="surname">
                ...
                <div class="form-login__wrapper">
                   <input class="form-login__password" 
                   type="password" 
                   placeholder="Пароль" 
                   id="first-password" 
                   v-model="password" >
                ...
                <button class="form-login__button" type="button" @click="sendReg">Зарегистрироваться</button>
             </form>
...
<style scoped>
.form-login__icon-email{
    position: absolute;
    left: 14px;
    top: 24px;
}
.form-login__icon_sur{
    position: absolute;
    left: 14px;
    top: 20px;
}
